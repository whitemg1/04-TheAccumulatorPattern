...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 1
    answer = count_cosines_from(0, 0, 0.29)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(4, 7, 0)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.9365  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(5, 11)
