...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Matt White.
...
#                                               count = 0
#              for k in range(r - s):           for k in range( s + 1 - r )
#                  count = 0
#                  if math.cos(r) > 0:          if math.cos( r + k ) > 0
...
#
#           It is used to signal that the loop variable is not used anywhere in the loop. This means the loop variable can be ignored.
#
...
#                  x = x + (2 * radius)
#
#               The second one is incorrect because x is updated by the diameter and by the multiple of k.
#
###############################################################################
